...
<div class="main">
    <form method="post" action="pegawai-tambah-process.php">
        <table>
            <tr>
                <td class="td"><strong>ID Pegawai</strong><br>
                <input type="text" name="idPegawai" size="50" maxlength="4" placeholder="Masukkan ID pegawai disini"
            ...
            <tr>
                ...
                <input type="text" name="namaPegawai" size="50" maxlength="30" placeholder="Masukkan nama pegawai disini"
