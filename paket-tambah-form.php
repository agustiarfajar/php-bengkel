...
<div class="main">
    <form method="post" action="paket-tambah-process.php">
        <table>
            <tr>
                <td class="td"><strong>Kode Paket</strong><br>
                <input type="text" name="kdPaket" size="50" maxlength="4" placeholder="Masukkan kode paket disini"
            ...
            <tr>
                ...
                <input type="text" name="namaPaket" size="50" maxlength="30" placeholder="Masukkan nama paket disini"
                pattern="[a-zA-Z0-9+\s]+" title="Isi dengan huruf, angka, atau tanda ( + )" required></td>
            </tr>
            <tr>
                <td class="td"><strong>Harga</strong><br>
                <input type="text" name="harga" size="50" maxlength="10" placeholder="Masukkan harga paket disini"
                pattern="[0-9]+" title="Isi dengan angka, tanpa titik." required></td>
            </tr>
        </table>
        <br>
