...
<?php
    if(isset($_GET["idPegawai"])) {
        ...
        if($data=getDataPegawai($idPegawai)){
            ?>
            <div class="main">
                <form method="post" action="pegawai-edit-process.php" >
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            value="<?php echo $data["namaPegawai"]; ?>" placeholder="Masukkan nama pegawai disini"
            ...
            <div class="error">
                ...
                <?php echo"PEGAWAI DENGAN ID : $idPegawai TIDAK ADA. PENGEDITAN DIBATALKAN"; ?>
            </div>
            <br>
            <a href="pegawai.php" class="btn-kembali"><i class="fa-solid fa-circle-chevron-left"></i>&nbspKembali</a>
            <?php
        ...
        <div class="error">
            <i class="fa-solid fa-fw fa-circle-exclamation" style="font-size:14px">&nbsp</i>
            ID PEGAWAI TIDAK ADA. PENGEDITAN DIBATALKAN
        </div>
        <br>
        <a href="pegawai.php" class="btn-kembali"><i class="fa-solid fa-circle-chevron-left"></i>&nbspKembali</a>
        <?php
