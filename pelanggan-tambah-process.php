...
<html><head><title>Tambah Pelanggan</title></head>
<style>
	body {
        background: #fff2f1;
        padding: 10px;
...
<div class="main">
    ...
    if(isset($_POST["btntambah"])) {
        ...
        if($db->connect_errno==0){
            ...
            $sql="INSERT INTO pelanggan (idPelanggan,namaPelanggan,jk,alamat,notelp) VALUES ('$idPelanggan','$namaPelanggan','$jk','$alamat','$notelp')";
            $res=$db->query($sql);
            if($res) {
