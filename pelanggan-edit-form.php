...
<html><head><title>Edit Pelanggan</title></head>
<style>
	body {
        background: #fff2f1;
        padding: 20px;
    ...
    if(isset($_GET["idPelanggan"])) {
        ...
        if($data=getDataPelanggan($idPelanggan)){
                ...
                <form method="post" action="pelanggan-edit-process.php" >
                    <table>
                        ...
                        <tr>
                            ...
                            value="<?php echo $data["alamat"]; ?>" placeholder="Masukkan alamat disini"
                        ...
                        <tr>
                            ...
                            value="<?php echo $data["notelp"]; ?>" placeholder="Masukkan no telp disini"
            ...
            <div class="error">
                ...
                <?php echo"PELANGGAN DENGAN ID : $idPelanggan TIDAK ADA. PENGEDITAN DIBATALKAN"; ?>
            </div>
            <br>
            <a href="pelanggan.php" class="btn-kembali"><i class="fa-solid fa-circle-chevron-left"></i>&nbspKembali</a>
            <?php
        ...
        <div class="error">
            <i class="fa-solid fa-fw fa-circle-exclamation" style="font-size:14px">&nbsp</i>
            ID PELANGGAN TIDAK ADA. PENGEDITAN DIBATALKAN
        </div>
        <br>
        <a href="pelanggan.php" class="btn-kembali"><i class="fa-solid fa-circle-chevron-left"></i>&nbspKembali</a>
        <?php
